...
total_flys_caught = 0
fly_held = False
total = font.render(f'Flys Eaten: {total_flys_caught}!', True, TEXT_BG, TEXT_BG)
...
while not done:
    ...
    pygame.draw.ellipse(screen, GREEN, [head_x+12, head_y+60, 125, 50])
    if not eating_fly:
        pygame.draw.ellipse(screen, GREY, [head_x+14, head_y+65, 120, 40])
    else:
        pygame.draw.ellipse(screen, GREEN, [head_x+14, head_y+65, 120, 40])
    ...
    pygame.draw.line(screen, BLACK, (line_x+12, line_y), (tongue_x+77, tongue_y+83), 2)

    # Fly
    pygame.draw.ellipse(screen, BLACK, [fly_x, fly_y, 20, 10])
    pygame.draw.line(screen, BLACK, (fly_x+2, fly_y+8), (fly_x, fly_y+12), 3)
    pygame.draw.line(screen, BLACK, (fly_x+5, fly_y+8), (fly_x+5, fly_y+12), 3)
    pygame.draw.line(screen, BLACK, (fly_x+18, fly_y+8), (fly_x+22, fly_y+12), 4)
    pygame.draw.line(screen, BLACK, (fly_x+8, fly_y+8), (fly_x+12, fly_y+12), 4)
    pygame.display.flip()
pygame.quit()
